...
use App\Resolvers\ContributorAuditResolver;
use App\Resolvers\PrivacyResolver;
...
return [
    ...
    */
    ...
    'user' => [
        ...
        'resolver' => ContributorAuditResolver::class,
    ],
    ...
    */
    'resolvers' => [
        'ip_address' => PrivacyResolver::class,
        'user_agent' => PrivacyResolver::class,
